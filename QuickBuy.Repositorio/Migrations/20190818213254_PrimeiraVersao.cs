        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descricao = table.Column<string>(type: "nvarchar", maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Senha = table.Column<string>(type: "nvarchar", maxLength: 400, nullable: false),
                    Nome = table.Column<string>(type: "nvarchar", maxLength: 50, nullable: false),
                    SobreNome = table.Column<string>(type: "nvarchar", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cep = table.Column<string>(type: "nvarchar", maxLength: 50, nullable: false),
                    ...
                    Endereco = table.Column<string>(type: "nvarchar", maxLength: 100, nullable: false),
                    NumeroEndereco = table.Column<string>(type: "nvarchar", maxLength: 20, nullable: false),
